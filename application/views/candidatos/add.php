        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-block">
                    ...
                    echo form_open('candidatos/store', $attributes)
                    ?>
                    ...
                    <div class="form-group <?php if (form_error('usuario_nombre')) { ?> has-danger <?php } ?> row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" name="usuario_nombre" value="<?php echo set_value('usuario_nombre'); ?>" placeholder="Escriba el nombre" id="usuario_nombre" class="form-control <?php if (form_error('usuario_nombre')) { ?> form-control-danger <?php } ?>">
                            </div>
                    ...
                    <div class="form-group <?php if (form_error('usuario_apellido')) { ?> has-danger <?php } ?> row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="icofont icofont-user"></i></span>
                                <input type="text" name="usuario_apellido" value="<?php echo set_value('usuario_apellido'); ?>" placeholder="Escriba el apellido" id="usuario_apellido" class="form-control <?php if (form_error('usuario_apellido')) { ?> form-control-danger <?php } ?>">
                            </div>
                                ...
                                <select name="usuario_tipodoc" id="usuario_tipodoc" class="form-control select2 <?php if (form_error('usuario_tipodoc')) { ?> form-control-danger <?php } ?>">
                                    <?php if (!empty($all_tiposdocumentos)) { ?>
                                        ...
                                        <?php foreach ($all_tiposdocumentos as $tiposdoc) { ?>
                                            <option value="<?php echo $tiposdoc->tipodocumento_id; ?>" <?= set_select('usuario_tipodoc', $tiposdoc->tipodocumento_id); ?>><?php echo $tiposdoc->tipodocumento_name; ?></option>
                                        <?php } ?>
                                    <?php } ?>
                                </select>
                            </div>
                    ...
                    <div class="form-group <?php if (form_error('usuario_numdoc')) { ?> has-danger <?php } ?> row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="icofont icofont-id-card"></i></span>
                                <input type="number" name="usuario_numdoc" value="<?php echo set_value('usuario_numdoc'); ?>" placeholder="Escriba el número de documento" id="usuario_numdoc" class="form-control <?php if (form_error('usuario_numdoc')) { ?> form-control-danger <?php } ?>">
                            </div>
                                ...
                                <select name="usuario_genero" id="usuario_genero" class="form-control select2 <?php if (form_error('usuario_genero')) { ?> form-control-danger <?php } ?>">
                                    <?php if (!empty($all_generos)) { ?>
                                        ...
                                        <?php foreach ($all_generos as $gene) { ?>
                                            <option value="<?php echo $gene->idgenero; ?>" <?= set_select('usuario_genero', $gene->idgenero); ?>><?php echo $gene->abrevia_genero; ?></option>
                                        <?php } ?>
                                    <?php } ?>
                                </select>
                            </div>
                    ...
                    <div class="form-group <?php if (form_error('usuario_email')) { ?> has-danger <?php } ?> row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="email" name="usuario_email" value="<?php echo set_value('usuario_email'); ?>" placeholder="Escriba el correo electrónico" id="usuario_email" class="form-control <?php if (form_error('usuario_email')) { ?> form-control-danger <?php } ?>">
                            </div>
                    ...
                    <div class="form-group <?php if (form_error('usuario_celular')) { ?> has-danger <?php } ?> row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="number" name="usuario_celular" value="<?php echo set_value('usuario_celular'); ?>" placeholder="Escriba el número de celular" id="usuario_celular" class="form-control <?php if (form_error('usuario_celular')) { ?> form-control-danger <?php } ?>">
                            </div>
                    ...
                    <div class="form-group <?php if (form_error('usuario_fechanacido')) { ?> has-danger <?php } ?> row">
                        ...
                        <div class="col-sm-10">
                            <input type="date" name="usuario_fechanacido" value="<?php echo set_value('usuario_fechanacido'); ?>" placeholder="Escriba el número de celular" id="usuario_fechanacido" class="form-control <?php if (form_error('usuario_fechanacido')) { ?> form-control-danger <?php } ?>">
                                ...
                                <select name="userprofe_profesion[]" id="userprofe_profesion" class="js-example-basic-multiple-limit form-control <?php if (form_error('userprofe_profesion[]')) { ?> form-control-danger <?php } ?>" multiple="multiple">
                                    <?php if (!empty($all_profesiones)) { ?>
                                        ...
                                        <?php foreach ($all_profesiones as $prof) { ?>
                                            <option value="<?php echo $prof->profesion_id; ?>" <?= set_select('userprofe_profesion[]', $prof->profesion_id); ?>><?php echo ucfirst(strtolower($prof->profesion_nombre)); ?></option>
                                        <?php } ?>
                                    <?php } ?>
                                </select>
                            </div>
                    ...
                    <div class="form-group <?php if (form_error('archivo_pdf')) { ?> has-danger <?php } ?> row">
                        ...
                        <div class="col-sm-10">
                            <input type="file" name="archivo_pdf" class="dropify form-control <?php if (form_error('archivo_pdf')) { ?> form-control-danger <?php } ?>" accept=".pdf" data-allowed-file-extensions="pdf" data-max-file-size="4M" />
                            <div class="input-group"></div>
                            <?php echo form_error("archivo_pdf"); ?>
                        </div>
                    </div>
                                ...
                                <select name="lider_id" id="lider_id" class="form-control select2 <?php if (form_error('lider_id')) { ?> form-control-danger <?php } ?>">
                                    <?php if (!empty($all_lideres)) { ?>
                                        ...
                                        <?php foreach ($all_lideres as $lid) { ?>
                                            <option value="<?php echo $lid->lider_id; ?>" <?= set_select('lider_id', $lid->lider_id); ?>><?php echo ucwords(strtolower($lid->lider_nombre . " " . $lid->lider_apellido)); ?></option>
                                        <?php } ?>
                                    <?php } ?>
                                </select>
                            </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2"></label>
                        <div class="col-sm-10">
                            <button type="submit" class="btn btn-primary m-b-0">Agregar candidato</button>
                        </div>
                    </div>
                    <?php
                    form_close();
