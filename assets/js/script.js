...
$(document).ready(function () {
	...
	i18next
		...
		$(".lng-dropdown a").on("click", function () {
			...
			var drop_lng = $(
				'.lng-dropdown a[data-lng="' + selected_lng + '"]'
			).addClass("active");
...
(function () {
	...
	var morphSearch_search =
		document.getElementsByClassName("morphsearch-search");
