...
$(document).ready(function(){
    ...
    function formatCandidatos(repo) {
        if (repo.loading) return repo.text;

        var markup = "<div class='select2-result-repository clearfix'>" +
            "<div class='select2-result-repository__meta'>" +
            "<div class='select2-result-repository__title'><i class='icofont icofont-star'></i>" + repo.lider_nombre +" "+ repo.lider_apellido + "</div>";

            if (repo.lider_direccion) {
                markup += "<div class='select2-result-repository__description'>" + repo.lider_direccion + "</div>";
            }
    ...
    function formatCandidatoSelection(repo) {
        return repo.lider_nombre || repo.text;
    }
    ...
    $(".data-ajax").select2({
        ...
        ajax: {
            url: baseurl+"/candidatos/getlideres",
            dataType: 'json',
            delay: 250,
        ...
        templateResult: formatCandidatos, // omitted for brevity, see the source of this page
        templateSelection: formatCandidatoSelection // omitted for brevity, see the source of this page
    });
